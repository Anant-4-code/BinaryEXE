...
- Transliterate prescriptions to multiple Indian languages
- Support for: Hindi, Tamil, Kannada, Marathi, Bengali, Telugu, Punjabi, Gujarati, Malayalam, Odia, Sanskrit
...
| **AI/LLM** | Ollama with Llama 3.2:3b (Local) |
| **OCR** | Tesseract / Custom Handwriting Service |
| **Image Processing** | Pillow + AVIF Support |
...
### Multi-Language Support
Transliterate to: Hindi 🇮🇳 | Tamil 🇮🇳 | Kannada 🇮🇳 | Marathi | Bengali | Telugu | Punjabi | Gujarati | Malayalam | Odia | Sanskrit
