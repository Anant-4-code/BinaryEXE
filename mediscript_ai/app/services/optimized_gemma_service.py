...
EXTRACT_MEDICINES_PROMPT = """Extract medicines from prescription text. You are a medical professional correcting OCR typos.
Correct common OCR mistakes involving numbers and letters (e.g., '505' -> 'SOS', 'TOS' or 'TD9' -> 'TDS', 'QGH' -> 'Q6H', 'LEVOUIN' -> 'LEVOLIN').
Translate medical abbreviations to readable patient instructions:
- 'TDS' or 'TID': "three times a day"
- 'BD' or 'BID': "twice a day"
- 'OD': "once a day"
- 'Q6H': "every 6 hours"
- 'SOS': "as needed" (put this in instructions if present)
...
[
  {{
    "medicine": "Cleaned Name",
    "dose": "dose amount",
    "frequency": "people-friendly frequency",
    "duration": "duration (e.g., 5 days)",
    "instructions": "any special instructions like 'as needed'",
    "age_range": "pediatric or adult depending on context"
  }}
]
